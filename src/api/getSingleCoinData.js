...
export const getSingleCoinData = async ({coinIDs = '', currency ='btc', page = 1, perPage = 250} = {}) => {
  ...
  return data.map(coin => {
    ...
    // const allColors = await jsonFetch(`https://www.coinpalette.com/colors?coins=${coin.id}`)
    // const color = allColors[0][coin.id]['vibrant']['hex']
